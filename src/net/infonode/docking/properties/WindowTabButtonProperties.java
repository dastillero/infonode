...
public class WindowTabButtonProperties extends PropertyMapContainer {
    ...
    /**
     * The button rollover icon.
     */
    public static final IconProperty ROLLOVER_ICON = new IconProperty(PROPERTIES,
            "Rollover Icon",
            "The button rollover icon.",
            PropertyMapValueHandler.INSTANCE);

    /**
     * The button icon when the button is pressed.
     */
    public static final IconProperty PRESSED_ICON = new IconProperty(PROPERTIES,
            "Pressed Icon",
            "The button icon when it is pressed.",
            PropertyMapValueHandler.INSTANCE);
     ...
     *
     * @param icon the rollover button icon.
     * @return this
     */
    public WindowTabButtonProperties setRolloverIcon(Icon icon) {
        ROLLOVER_ICON.set(getMap(), icon);
        return this;
    }

    /**
     * Returns the button rollover icon.
     *
     * @return the button rollover icon.
     */
     ...
     *
     * @param icon the icon to show when the button is selected.
     * @return this
     */
    public WindowTabButtonProperties setPressedIcon(Icon icon) {
        PRESSED_ICON.set(getMap(), icon);
        return this;
    }

    /**
     * Returns the icon when the button is pressed.
     *
     * @return the icon when the button is pressed.
     */
